    ...
    return (
        <div className={'pt-10 flex flex-wrap gap-5 pl-52 '}>
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                <img className={'m-auto rounded-full'} width={"150"} src={require("../assets/pizza.jpg")} alt=""/>
                <h1 className={'font-bold '}>Pizza Italiano</h1>
                <p className={'text-xs my-3'}>80 sm</p>
            ...
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                <img className={'m-auto rounded-full'} width={"150"} src={require("../assets/pizza.jpg")} alt=""/>
                <h1 className={'font-bold '}>Pizza Italiano</h1>
                <p className={'text-xs my-3'}>62 sm</p>
                <h2 className={'font-bold text-xl mt-5'}>$6.50</h2>
                <div className={'mt-4 flex items-center justify-center'}>
                    <button onClick={() => {
            ...
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                <img className={'m-auto rounded-full'} width={"150"} src={require("../assets/pizza.jpg")} alt=""/>
                <h1 className={'font-bold '}>Pizza Italiano</h1>
                <p className={'text-xs my-3'}>45 sm</p>
                <h2 className={'font-bold text-xl mt-5'}>$5.30</h2>
                <div className={'mt-4 flex items-center justify-center'}>
                    <button onClick={() => {
            ...
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                ...
                <h1 className={'font-bold '}>Pizza Italiano</h1>
                <p className={'text-xs my-3'}>62 sm</p>
                <h2 className={'font-bold text-xl mt-5'}>$8.50</h2>
                <div className={'mt-4 flex items-center justify-center'}>
                    <button onClick={() => {
            ...
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                <img className={'m-auto rounded-full'} width={"150"} src={require("../assets/pizza.jpg")} alt=""/>
                <h1 className={'font-bold '}>Pizza Italiano</h1>
                <p className={'text-xs my-3'}>72 sm</p>
                <h2 className={'font-bold text-xl mt-5'}>$10.50</h2>
                <div className={'mt-4 flex items-center justify-center'}>
                    <button onClick={() => {
            ...
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                <img className={'m-auto rounded-full'} width={"150"} src={require("../assets/pizza.jpg")} alt=""/>
                <h1 className={'font-bold '}>Pizza Italiano</h1>
                <p className={'text-xs my-3'}>52 sm</p>
                <h2 className={'font-bold text-xl mt-5'}>$5.50</h2>
                <div className={'mt-4 flex items-center justify-center'}>
                    <button onClick={() => {
            ...
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                ...
                <h1 className={'font-bold '}>Pizza Italiano</h1>
                <p className={'text-xs my-3'}>80 sm</p>
                <h2 className={'font-bold text-xl mt-5'}>$2.50</h2>
                <div className={'mt-4 flex items-center justify-center'}>
                    <button onClick={() => {
