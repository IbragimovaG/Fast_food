...
function Burgers(props) {
    ...
    return (
        <div className={'pt-10 flex flex-wrap gap-5 lg:pl-52 sm '}>
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                <img className={'m-auto rounded-full'} width={"100"} src={require("../assets/burger.avif")} alt=""/>
                <h1 className={'font-bold '}>Royale De Luxe</h1>
                <p className={'text-xs my-3'}>450 g</p>
