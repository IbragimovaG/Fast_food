    ...
    return (
        <div className={'pt-10 flex flex-wrap gap-5 pl-52 '}>
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                <img className={'m-auto rounded-full'} width={"150"} src={require("../assets/burrito1.jpg")} alt=""/>
                <h1 className={'font-bold '}>
                    California Burrito</h1>
                <p className={'text-xs my-3'}>Large</p>
            ...
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                <img className={'m-auto rounded-full'} width={"150"} src={require("../assets/burrito1.jpg")} alt=""/>
                <h1 className={'font-bold '}>California Burrito</h1>
                <p className={'text-xs my-3'}>Large</p>
            ...
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                <img className={'m-auto rounded-full'} width={"150"} src={require("../assets/burrito1.jpg")} alt=""/>
                <h1 className={'font-bold '}>California Burrito</h1>
                <p className={'text-xs my-3'}>Average</p>
            ...
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                <img className={'m-auto rounded-full'} width={"150"} src={require("../assets/burrito1.jpg")} alt=""/>
                <h1 className={'font-bold '}>California Burrito</h1>
                <p className={'text-xs my-3'}>Big</p>
            ...
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                ...
                <h1 className={'font-bold '}>California Burrito</h1>
                <p className={'text-xs my-3'}>Big</p>
                <h2 className={'font-bold text-xl mt-5'}>$15.50</h2>
                <div className={'mt-4 flex items-center justify-center'}>
                    <button onClick={() => {
