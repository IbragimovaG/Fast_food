    ...
    return (
        <div className={'pt-10 flex flex-wrap gap-5 pl-52 '}>
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                <img className={'m-auto rounded-full'} width={"100"} src={require("../assets/muffin.jpg")} alt=""/>
                <h1 className={'font-bold '}>
                    Chocolate Muffin</h1>
                <p className={'text-xs my-3'}>150 g</p>
            ...
            <div className={'w-1/5 h-72 rounded-xl bg-white hover:bg-red-600 hover:text-white shadow-2xl p-5'}>
                <img className={'m-auto rounded-full'} width={"100"} src={require("../assets/muffin.jpg")} alt=""/>
                <h1 className={'font-bold '}> Chocolate Muffin</h1>
                <p className={'text-xs my-3'}>150 g</p>
                <h2 className={'font-bold text-xl mt-5'}>$5.50</h2>
                <div className={'mt-4 flex items-center justify-center'}>
                    <button onClick={() => {
